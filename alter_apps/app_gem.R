...
ui <- fluidPage(
  ...
  # 1. Application Title
  titlePanel("PT Data Analysis Application (app_gem.R v1.0)"),
  ...
  conditionalPanel(
    ...
    wellPanel(
      themeSelector(),
      hr(),
      sliderInput("nav_width", "Navigation Panel Width:", min = 2, max = 4, value = 3, width = "250px"),
      sliderInput("analysis_sidebar_width", "Analysis Sidebar Width:", min = 2, max = 5, value = 3, width = "250px")
    )
  ),
  hr(),
