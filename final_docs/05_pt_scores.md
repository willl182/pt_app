...
**Uso recomendado**: cuando la incertidumbre del valor asignado es despreciable, por ejemplo $u(x_{pt}) \le 0.3\,\sigma_{pt}$.
...
| Resultado | Criterio |
|-----------|----------|
| Satisfactorio | $|z| \leq 2$ |
| Cuestionable | $2 < |z| < 3$ |
| No satisfactorio | $|z| \geq 3$ |
...
| Resultado | Criterio |
|-----------|----------|
| Satisfactorio | $|E_n| \leq 1$ |
| No satisfactorio | $|E_n| > 1$ |
...
- [10_informe_global.md](10_informe_global.md) - Mapas de calor de evaluación
