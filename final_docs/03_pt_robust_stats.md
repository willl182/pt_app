...
## Descripción
Este archivo contiene estimadores estadísticos robustos utilizados para calcular valores asignados ($x_{pt}$) y desviaciones estándar resistentes a valores atípicos. Implementa los métodos descritos en ISO 13528:2022 y soporta el consenso mediante Algoritmo A.
