...
# Uso: Rscript scripts/aplicativo/preprocesar_calaire.R
...
levels_path <- get_arg_value("--levels")
design_path <- get_arg_value("--design")
...
result_estab <- do.call(
  run_pipeline_calaire,
  c(args_common, list(design_path = design_path))
)
