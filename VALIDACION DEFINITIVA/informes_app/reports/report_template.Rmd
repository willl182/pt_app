...
if (method == "2a") {
  ...
  cat("Se evaluó la compatibilidad metrológica para el método de expertos, usando el valor de referencia como $x_{pt}$ y la desviación para evaluación de aptitud calculada con la ecuación operativa por contaminante.")
} else {
...
if (is_nonempty_df(params$homogeneity_summary)) {
  ...
  hom_df <- safe_rename_by_position(
    hom_df,
    c("Contaminante", "Nivel", "Items", "Réplicas", "sigma_pt", "u(x_pt)", "ss", "sw", "Criterio c", "Cumple", "Conclusión")
  )
...
if (is_nonempty_df(params$stability_summary)) {
  ...
  stab_df <- safe_rename_by_position(
    stab_df,
    c("Contaminante", "Nivel", "Items", "Réplicas", "sigma_pt", "u(x_pt)", "Diferencia", "Criterio c", "Cumple", "Conclusión")
  )
