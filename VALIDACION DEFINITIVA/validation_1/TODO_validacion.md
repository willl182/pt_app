# TODO_validacion.md — Reset a cero

**Proyecto**: Validación de cálculos del Aplicativo PT  
**Estado**: TODO-ZERO — todo requiere revisión, nada se asume correcto  
...
# 2. Etapa 1 — Robust Stats (FASE 1) — Requiere revisión — O3 × 3 niveles

* [ ] Revisar script `stage_01_robust_stats.R` línea por línea
* [ ] Revisar script `stage_01_robust_stats.py` línea por línea
* [ ] Confirmar que filtran O3 correctamente (3 niveles)
* [ ] Confirmar que excluyen `ref`
* [ ] Confirmar cálculo de mediana, MAD, MADe, nIQR
* [ ] Confirmar factores: 1.483 (MADe), 0.7413 (nIQR)
* [ ] Confirmar cuartiles type=7 en R
* [ ] Ejecutar para O3_0
* [ ] Ejecutar para O3_80
* [ ] Ejecutar para O3_180
* [ ] Comparación tripartita app/R/Python (O3 × 3)
* [ ] Generar/revisar CSV: `stage_01_robust_stats.csv`
* [ ] Generar/revisar reporte: `stage_01_robust_stats_report.md`
* [ ] Clasificar resultados (PASS/FAIL/EDGE_CASE/KNOWN_DISCREPANCY)

---

# 3. Etapa 2 — Homogeneidad (FASE 2) — Requiere revisión — O3 × 3 niveles

* [ ] Revisar script `stage_02_homogeneity.R` línea por línea
* [ ] Revisar script `stage_02_homogeneity.py` línea por línea
* [ ] Confirmar filtro O3 (3 niveles)
* [ ] Confirmar pivot a formato ancho (g × m)
* [ ] Confirmar cálculo ANOVA: media general, s²_x̄, sw, ss², ss
* [ ] Confirmar criterio simple (MADe y nIQR)
* [ ] Confirmar criterio expandido (F1/F2 con sw y g)
* [ ] Confirmar conclusión: ss ≤ c → CUMPLE
* [ ] Ejecutar para O3_0
* [ ] Ejecutar para O3_80
* [ ] Ejecutar para O3_180
...
# 4. Etapa 3 — Estabilidad (FASE 3) — Requiere revisión — O3 × 3 niveles

* [ ] Revisar script `stage_03_stability.R` línea por línea
* [ ] Revisar script `stage_03_stability.py` línea por línea
* [ ] Confirmar filtro O3 (3 niveles)
* [ ] Confirmar cálculo de ANOVA de estabilidad
* [ ] Confirmar Dmax = |media_hom - media_stab|
* [ ] Confirmar criterio c_stab usando MADe de **homogeneidad**
* [ ] Confirmar criterio expandido de estabilidad
* [ ] Confirmar cálculo u_hom y u_stab
* [ ] Documentar discrepancia conocida u_stab si persiste
* [ ] Ejecutar para O3_0
* [ ] Ejecutar para O3_80
* [ ] Ejecutar para O3_180
* [ ] Comparación tripartita (O3 × 3)
