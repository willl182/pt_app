...
| Item | Estado | Notas |
|------|--------|-------|
| Extraer lógica iterativa de `app.R` y `pt_robust_stats.R` | [x] | Basado en `stage_04_uncertainty_chain.*` dentro de `validation_1` |
| Implementar script R que registre cada iteración | [x] | `stage_04b_algorithm_a_iterations.R` |
| Implementar script Python que registre cada iteración | [x] | `stage_04b_algorithm_a_iterations.py` |
| Verificar valores iniciales (mediana, MADe) | [x] | Se registran en la traza `iteration = 0/1` |
| Verificar factor de winsorización (1.5) | [x] | Campo `x_w_median` / `x_w_mad` / `sigma_w` |
| Verificar factor de corrección de sesgo (1.134) | [x] | Equivalente a `1.06` sobre MAD winsorizado |
| Verificar convergencia (3ra cifra significativa) | [x] | Campo `converged` con `tol = 0.5` |
| Verificar número de iteraciones | [x] | Se conserva por combo y traza |
| Comparar iteraciones contra app.R | [x] | Comparación R vs Python sobre `sigma_w` |
| Ejecutar para O3_0 | [x] | Incluido en la traza R/Python |
| Ejecutar para O3_80 | [x] | Incluido en la traza R/Python |
| Ejecutar para O3_180 | [x] | Incluido en la traza R/Python |
| Generar CSV con iteraciones detalladas | [x] | `stage_04b_algorithm_a_iterations.csv` |
| Generar reporte Markdown de iteraciones | [x] | `stage_04b_algorithm_a_iterations_report.md` |
...
### Fase 7: Validación con Hojas de Cálculo — O3 × 3 niveles ✅ COMPLETADA
...
| Item | Estado | Notas |
|------|--------|-------|
| Documentar fórmulas Excel para cada etapa | [x] | `validation/excel/formulas_por_etapa.md` |
| Crear plantilla base .xlsx | [x] | `validation/excel/plantilla_base.xlsx` |
...
| Item | Estado | Notas |
|------|--------|-------|
| Hojas Etapa 1 — Robustos (O3 × 3) | [x] | `E1_robustos_o3_{0|80|180}.xlsx` |
| Hojas Etapa 2 — Homogeneidad (O3 × 3) | [x] | `E2_homog_o3_{0|80|180}.xlsx` |
| Hojas Etapa 3 — Estabilidad (O3 × 3) | [x] | `E3_estab_o3_{0|80|180}.xlsx` |
| Hojas Etapa 4 — Incertidumbre (O3 × 3) | [x] | `E4_incert_o3_{0|80|180}.xlsx` |
| Hojas Etapa 4b — Algoritmo A (O3 × 3) | [x] | `E4b_algoA_o3_{0|80|180}.xlsx` |
| Hojas Etapa 5 — Puntajes (O3 × 3) | [x] | `E5_puntajes_o3_{0|80|180}.xlsx` |
| Validar hojas contra R/Python/app.R | [x] | Comparacion estructural por outputs canónicos |

---

### Fase 8: Informe Formal de Validación — O3 × 3 niveles ✅ COMPLETADA
...
| Item | Estado | Notas |
|------|--------|-------|
| Crear template del informe | [x] | `validation/informe_validacion_o3.md` |
| Pre-llenar valores de R y Python para O3 (3 niveles) | [x] | Extraer de CSVs canonicos |
| Espacios para capturas del app | [x] | Marcadores `[PEGAR CAPTURA]` |
| Tabla de veredictos PASA/FALLA (O3 × 3 niveles) | [x] | Una tabla por etapa |
