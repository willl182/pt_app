...
## Sistema de Clasificacion (a1-a7)

El modulo implementa una clasificacion combinada z+En segun ISO 13528:

| Codigo | Clasificacion | Criterio z | Criterio En |
|--------|---------------|------------|-------------|
| a1 | Totalmente satisfactorio | \|z\| <= 2 | \|En\| <= 1 |
| a2 | Satisfactorio pero conservador | \|z\| <= 2 | \|En\| < 1 (muy pequeno) |
| a3 | Satisfactorio con MU subestimada | \|z\| <= 2 | \|En\| > 1 |
| a4 | Cuestionable pero aceptable | 2 < \|z\| < 3 | \|En\| <= 1 |
| a5 | Cuestionable e inconsistente | 2 < \|z\| < 3 | \|En\| > 1 |
| a6 | No satisfactorio pero MU cubre | \|z\| >= 3 | \|En\| <= 1 |
| a7 | No satisfactorio (critico) | \|z\| >= 3 | \|En\| > 1 |
...
pt_en_class_colors <- c(
  ...
  a2 = "#66BB6A",   # Verde claro
  a3 = "#9CCC65",   # Verde lima
...
| `classify_with_en()` | Clasificacion combinada z+En |
