...
Rscript -e "testthat::test_dir('Entregables_pt_app/05_prototipo_ui/tests')"

# Opción 2: Desde R console
library(testthat)
test_dir("Entregables_pt_app/05_prototipo_ui/tests")
```
...
test_file("Entregables_pt_app/05_prototipo_ui/tests/test_05_navegacion.R")
```
...
test_file("Entregables_pt_app/05_prototipo_ui/tests/test_05_navegacion.R", filter = "HTML")
```
...
Abrir el archivo `Entregables_pt_app/05_prototipo_ui/html/prototipo.html` en un navegador web y verificar los siguientes aspectos:
...
Al ejecutar `testthat::test_dir("Entregables_pt_app/05_prototipo_ui/tests")`, se esperan los siguientes resultados:
