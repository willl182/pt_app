...
funciones_principales <- list(
  ...
  list(
    ...
    archivo = "pt_homogeneity.R",
    parametros = c("stab_sample_data", "hom_general_mean_homog", "hom_stab_x_pt", "hom_stab_sigma_pt"),
    test_valores = list(stab_sample_data = matrix(c(10.1, 10.3, 10.2, 10.4), nrow = 2, ncol = 2), hom_general_mean_homog = 10.2, hom_stab_x_pt = 10.2, hom_stab_sigma_pt = 0.5)
  ),
  list(
