...
setwd("Entregables_pt_app/08_beta")
...
Rscript Entregables_pt_app/08_beta/app_final.R
```

### Opción 3: Usando el atajo en RStudio

1. Abrir `Entregables_pt_app/08_beta/app_final.R` en RStudio
...
**Solución:**
- Verificar que los archivos están en `data/` relativo a `Entregables_pt_app/08_beta/`
