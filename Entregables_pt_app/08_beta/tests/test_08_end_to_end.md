...
# Ejecutar el test
testthat::test_file("Entregables_pt_app/08_beta/tests/test_08_end_to_end.R")
```
...
Rscript -e "testthat::test_file('Entregables_pt_app/08_beta/tests/test_08_end_to_end.R')"
```

### Opción 3: Desde RStudio

1. Abrir `Entregables_pt_app/08_beta/tests/test_08_end_to_end.R` en RStudio
...
**Solución:**
- Verificar que el archivo existe en `Entregables_pt_app/08_beta/R/funciones_finales.R`
- Verificar que hay permisos de lectura
- Ejecutar `source("Entregables_pt_app/08_beta/R/funciones_finales.R")` manualmente
...
```r
# Cargar funciones
source("Entregables_pt_app/08_beta/R/funciones_finales.R")
