...
- Confirma que las 5 copias existen en `Entregables_pt_app/01_repo_inicial/`
...
setwd("Entregables_pt_app/01_repo_inicial/tests")
...
test_file("Entregables_pt_app/01_repo_inicial/tests/test_01_existencia_archivos.R")
```

### Opción 3: Ejecutar desde la línea de comandos

```bash
Rscript Entregables_pt_app/01_repo_inicial/tests/test_01_existencia_archivos.R
```
...
Resultados guardados en: Entregables_pt_app/01_repo_inicial/test_01_resultados.csv
```
...
- **Falta archivo copia:** El archivo no fue copiado a `Entregables_pt_app/01_repo_inicial/`
