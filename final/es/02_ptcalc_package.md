...
|---------|------------|---------|----------------|
| `calculate_niqr` | `x` (numérico) | Valor nIQR (0.7413 * IQR) | 13528:2022 §9.4 |
| `calculate_mad_e` | `x` (numérico) | Valor MADe (1.483 * MAD) | 13528:2022 §9.4 |
...
| Función | Parámetros | Retorno | Referencia ISO |
|---------|------------|---------|----------------|
| `calculate_homogeneity_stats` | `sample_data` (df/matriz) | Lista: `g`, `m`, `grand_mean`, `sw`, `ss`, etc. | 13528:2022 §9.2 |
...
|-----------|------|-------------|
| `PT_EN_CLASS_LABELS` | Vector con nombre | Etiquetas para la clasificación combinada z/En (a1 a a7). |
| `PT_EN_CLASS_COLORS` | Vector con nombre | Códigos de colores hexadecimales para visualizaciones de clasificación. |
...
| Varianza cero | Manejada con una alternativa (fallback) a la desviación estándar clásica si aplica. |

---

## Uso en la Aplicación

### Ejemplo: Uso en un Reactivo de Shiny
```r
