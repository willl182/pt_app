...
| **Líneas (UI)** | `tabPanel("Valores Atípicos")` (Líneas 858-876) |
| **Líneas (Lógica)** | Expresión reactiva `grubbs_summary()` (Líneas 3801-3938) |
| **Librería R** | `outliers` |
...
Esta expresión reactiva construye una tabla maestra evaluando todas las combinaciones de datos disponibles.
