...
info_data <- data.frame(
  Campo = c(
    "Nombre y Contacto del Proveedor de EA",
    "Identificación Única del Esquema de EA",
    "Identificación Única del Informe",
    "Estado del Informe",
    "Fecha de Emisión",
    "Periodo del Ensayo",
    "Declaración de Servicios Externos"
  ),
  Valor = c(
    "Laboratorio CALAIRE Campus El Volador, Cra 65 No59A - 110 Bloque 19A, laboratorio 401 calaire_med@unal.edu.co 314 874 8191",
    params$scheme_id,
    params$report_id,
    "FINAL",
    as.character(params$issue_date),
    params$period,
...
kable(info_data, col.names = NULL, caption = "Tabla 1 Información del Ensayo de Aptitud")
```

## 1.2. Alcance y Objetivo del EA
...
## 3.1. Desviación Estándar para Evaluación de Aptitud (σ)
...
Los valores de σ_pt calculados para cada nivel se presentan en el Anexo A.
