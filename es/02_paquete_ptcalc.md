...
- **Algoritmo A (Winsorización):**
  - `δ = 1.5 × s*`
  - `x_winsorized = clamp(x_i, x* - δ, x* + δ)` (valores limitados a [x* - δ, x* + δ])
  - `x*nuevo = mean(x_winsorized)`
  - `s*nuevo = 1.134 × √[Σ(x* - x_winsorized)²/(p-1)]`
...
- [02a_api_ptcalc.md](02a_api_ptcalc.md) - Referencia API completa con ejemplos detallados.
- [03_estadisticas_robustas_pt.md](03_estadisticas_robustas_pt.md) - Documentación profunda de estadísticos robustos.
- [04_homogeneidad_pt.md](04_homogeneidad_pt.md) - Manual de homogeneidad.
- [05_puntajes_pt.md](05_puntajes_pt.md) - Guía detallada de puntajes.
