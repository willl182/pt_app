...
| **Dependencias** | `pt_prep_data()`, `algoA_results_cache()`, `consensus_results_cache()`, `ptcalc` package |
...
| Iteraciones Algo A | - | `algoA_iterations_table` | dataTableOutput | Log de convergencia del proceso. |
...
- **Estadísticos Robustos:** [03_estadisticas_robustas_pt.md](03_estadisticas_robustas_pt.md)
- **Carga de Datos:** [01_carga_datos.md](01_carga_datos.md)
- **Cálculo de Puntajes PT:** [05_puntajes_pt.md](05_puntajes_pt.md)
- **Glosario:** [00_glosario.md](00_glosario.md)
