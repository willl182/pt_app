...
flowchart TD
    ...
    subgraph Entrada_Usuario
        ...
        COMPAT[input$report_metrological_compatibility_method] --> COMPAT_DATA[metrological_compatibility_data]
...
params:
  ...
  metrological_compatibility: !r data.frame()
  metrological_compatibility_method: "2a"
```

### 5.2 Paso de Parámetros de Compatibilidad Metrológica

Los datos de compatibilidad metrológica se pasan a la plantilla del informe a través de dos parámetros:

**metrological_compatibility**: Data frame que contiene las comparaciones de compatibilidad de los tres métodos.
- Columnas: pollutant, n_lab, level, x_pt_ref, x_pt_2a, x_pt_2b, x_pt_3, Diff_Ref_2a, Diff_Ref_2b, Diff_Ref_3.
- Fuente: reactivo `metrological_compatibility_data()` en app.R.

**metrological_compatibility_method**: Método de consenso seleccionado para la comparación.
- Opciones: "2a", "2b" o "3".
- Fuente: `input$report_metrological_compatibility_method`.

La plantilla filtra dinámicamente la tabla de compatibilidad basándose en el método seleccionado, mostrando solo el valor de consenso y la diferencia relevantes.
...
*   [00_glosario.md](00_glosario.md): Definiciones de términos estadísticos.
